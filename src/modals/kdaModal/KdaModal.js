...
export default function Account(props) {
  ...
  const [method, setMethod] = useState("sign");
      ...
      <Modal.Content image>
        <Modal.Description>
          <Header style={{ marginBottom: 24 }}>
            ...
            >
              TESTNET chain 0 KDA Account <a
                style={{ marginLeft: 3}}
                href="https://faucet.testnet.chainweb.com/"
                target="_blank"
              >
                (fund testnet tokens here)
              </a>
            </span>
          </Header>
          <Button
          ...
          {pact.account.account ? (
            ...
            <Header>
              <span
                style={{ color: "red", fontSize: 24, fontFamily: "montserrat-bold" }}
              >
            ...
            <>
              {method === "pk" && (
                <>
                  ...
                  >
                    ...
                    >
                      All your transactions will be automatically signed with
                      these keys
                    </span>
                    <span
                      style={{
              ...
              {method === "pk+pw" && (
                <>
                  ...
                  >
                    ...
                    >
                      You will be prompted to enter your password to submit
                      transactions
                    </span>
                    <span
                      style={{
                    ...
                    >
                      You can always reset your password by following this
                      process again with your private key
                    </span>
                  </div>
                  <Input
              ...
              {method === "sign" && (
                ...
                >
                  ...
                  <span
                    style={{ color: "#1B781B", fontSize: 13, marginBottom: 10 }}
                  >
                  ...
                  >
                    ...
                    <a
                      style={{ color: "#1B781B", textDecoration: "underline" }}
                    >
                      here
                    </a>
                  </span>
