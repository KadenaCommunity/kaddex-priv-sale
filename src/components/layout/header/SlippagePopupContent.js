...
const SlippageTolleranceValue = styled.div`
  ...
  color: #FFFFFF;
  text-shadow: ${({ isSelected }) => (isSelected ? '0 0 5px #FFFFFF;' : 'none')};
  font-family: montserrat-regular;
  font-size: 14px;
  padding: 6.5px 8.5px;
  min-width: 48px;
    ...
    <Container>
      ...
      <Row style={{ marginTop: 8 }}>
        ...
        <ContainerInputTypeNumber>
          ...
          <Input
            containerStyle={{border: "none !important", boxShadow: "none !important"}}
            placeholder={slp}
            numberOnly
            value={slp}
            onChange={(e, { value }) => {
      ...
      <Row style={{ marginTop: 8 }}>
        ...
        <RegularLabel style={{ color: "#FFFFFF", marginLeft: 8 }}>minutes</RegularLabel>
      </Row>
    </Container>
  );
};
