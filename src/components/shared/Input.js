...
const Input = ({
  ...
  const getIcon = () => {
    if (withSelectButton && !inputRightComponent)
      return (
        <Button onClick={onSelectButtonClick} style={{border: "1px solid #FFFFFF", boxShadow: "0 0 3px #FFFFFF"}}>
          <span>
            {buttonLabel}
  ...
  return (
    ...
    >
      {(topLeftLabel || topRightLabel) && (
        <TopLabelsContainer>
          {topLeftLabel && (
            <span style={{ fontFamily: "montserrat-bold", ...topLeftLabelStyle }}>
              {topLeftLabel}
            </span>
          )}
          {topRightLabel && (
      ...
      {(bottomLeftLabel || bottomRightLabel) && (
        <BottomLabelsContainer>
          {bottomLeftLabel && (
            <span
              style={{ fontFamily: "montserrat-regular", ...bottomLeftLabelStyle }}
            >
              {bottomLeftLabel}
            </span>
          )}
