      ...
      {(show) =>
        ...
        ((props) => (
          <Container style={props}>
            ...
            <ModalContainer title="Preview Successful!" containerStyle={{ height: '100%', maxHeight: '80vh', maxWidth: '90vw' }} onClose={onClose}>
            <Content>
            <SuccessfulIcon />
            ...
            {liquidityView === "Add Liquidity"
              ...
              <TransactionsDetails>
                <SubTitleContainer>
                  <SubTitle style={{ marginBottom: "15px", justifyContent: "center" }}>Deposit Desired:</SubTitle>
                </SubTitleContainer>
                <SpaceBetweenRow>
                ...
                <SubTitleContainer>
                  <SubTitle style={{ marginBottom: "15px", justifyContent: "center" }}>Rates:</SubTitle>
                </SubTitleContainer>
                <SpaceBetweenRow>
