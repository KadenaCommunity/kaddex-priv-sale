...
const PasswordPopup = ({}) => {
          ...
          <Message size='tiny' color='purple' style={{textAlign: 'center'}}>
            <RowContainer>
              <div style={{ display: 'flex', flexFlow: 'column', alignItems: 'center' }}>
                <span style={{ fontFamily: 'montserrat-bold', fontSize: 16, marginBottom: 10 }}><Icon name='warning sign' /> Note</span>
                <span>
  ...
  // return (
  //         <Container>
  //           <ModalContainer title="sign transaction" containerStyle={{ height: '100%', maxHeight: '80vh', maxWidth: '90vw' }}
  //           // onClose={onClose}
  //           >
  //             {password()}
  //           </ModalContainer>
  ...
  // );
  return (
    <ModalContainer title="sign transaction"
    //           // onClose={onClose}
              >
      <SubTitle>Enter Password To Decrypt Private Key</SubTitle>
      <TransactionsDetails>
